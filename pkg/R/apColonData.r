...
#' pData(apColonData)
#'
#' @seealso \code{\link{ExpressionSet}} for the class definition, \code{\link[frma]{frma}} for the preprocessing method used, \code{\link[frma]{barcode}} for the function to obtain the z-score definition, \code{\link{apStats}} and \code{\link{buildAntiProfile}} for methods to build anti-profiles from this data.
#'
#' @references
